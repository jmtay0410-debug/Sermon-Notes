...
function ClassicTabLayout() {
  ...
  return (
    ...
    >
      ...
      />
      <Tabs.Screen name="sermons" options={{ title: 'Sermons', tabBarIcon: ({ color }) => isIOS ? <SymbolView name="book.closed" tintColor={color} size={23} /> : <Feather name="book-open" size={21} color={color} /> }} />
      <Tabs.Screen name="bible" options={{ title: 'Bible', tabBarIcon: ({ color }) => isIOS ? <SymbolView name="text.book.closed" tintColor={color} size={23} /> : <Feather name="book" size={21} color={color} /> }} />
